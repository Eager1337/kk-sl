...
const Wholesale = () => {
  ...
  return (
    <Layout>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border/50 shadow-md">
            <svg viewBox="0 0 320 200" className="w-full h-auto">
              ...
              {[0, 25, 50, 75, 100].map((g) => (
                <line key={g} x1="30" x2="310" y1={180 - g * 1.5} y2={180 - g * 1.5} stroke="hsl(var(--border))" strokeDasharray="2 3" />
              ))}
              {(() => {
                  ...
                  <>
                    ...
                    {pts.map((p, i) => (
                      <g key={i}>
                        ...
                        <text x={p.x} y={p.y - 12} textAnchor="middle" fontSize="10" fill="hsl(var(--foreground))" fontWeight="600">
                          {GROWTH[i].v}
                        </text>
                        <text x={p.x} y="195" textAnchor="middle" fontSize="10" fill="hsl(var(--muted-foreground))">
                          {GROWTH[i].y}
                        </text>
                      </g>
                    ))}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {RECIPES.map((r) => (
              <article
                ...
                style={{ background: `linear-gradient(180deg, hsl(${r.accent} / 0.10), hsl(var(--card)) 60%)` }}
              >
      ...
      <section id="stockist" className="py-20 px-6">
